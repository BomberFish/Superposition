...
async function fetchAndApply(request) {
	...
	if (content_type.includes('text/html') && urlParam != 'https://superposition-landing.bomberfish.ca') {
		original_text = await addButton(original_text);
	}
